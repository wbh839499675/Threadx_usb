...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _ux_host_class_meige_read                            PORTABLE C     */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*  DESCRIPTION                                                           */
/*                                                                        */
/*    This function reads from the meige interface. The call is           */
                                    ...
                                    ULONG requested_length, ULONG *actual_length)
{
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_HOST_CLASS_MEIGE_READ, meige, data_pointer, requested_length, 0, UX_TRACE_HOST_CLASS_EVENTS, 0, 0)
    ...
    *actual_length =  0;
    ...
    while (requested_length)
    {
        ...
        if (status == UX_SUCCESS)
        {
            ...
            status =  _ux_utility_semaphore_get(&transfer_request->ux_transfer_request_semaphore, UX_MS_TO_TICK(UX_HOST_CLASS_MEIGE_CLASS_TRANSFER_TIMEOUT));
