...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _ux_host_class_meige_write                           PORTABLE C      */ 
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*  DESCRIPTION                                                           */
/*                                                                        */ 
/*    This function writes to the meige interface. The call is blocking    */ 
                                    ...
                                    ULONG requested_length, ULONG *actual_length)
{
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_HOST_CLASS_MEIGE_WRITE, meige, data_pointer, requested_length, 0, UX_TRACE_HOST_CLASS_EVENTS, 0, 0)

    /* Ensure the instance is valid. */
    if (_ux_host_stack_class_instance_verify((UCHAR *)_ux_system_host_class_meige_name, (VOID *)meige) != UX_SUCCESS)
    {
        ...
        printf("usb host calss instance unknown\r\n");
    ...
    {
        printf("usb get semaphore failed\r\n");
        return(status);
    }
    ...
    *actual_length = 0;
    ...
    transfer_request = &meige->ux_host_class_meige_bulk_out_endpoint->ux_endpoint_transfer_request;
    ...
    do
    {
        ...
        if (status == UX_SUCCESS)
        {
            ...
            status =  _ux_utility_semaphore_get(&transfer_request->ux_transfer_request_semaphore, UX_HOST_CLASS_MEIGE_CLASS_TRANSFER_TIMEOUT);
            ...
            if (status != UX_SUCCESS)
            {
                ...
                *actual_length +=  transfer_request->ux_transfer_request_actual_length;
                ...
                status =  _ux_utility_semaphore_put(&meige -> ux_host_class_meige_semaphore);
