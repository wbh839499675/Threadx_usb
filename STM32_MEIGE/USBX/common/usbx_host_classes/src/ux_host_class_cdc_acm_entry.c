...
#else
        printf("command -> ux_host_class_command_usage = 0x%02x\r\n", command -> ux_host_class_command_usage);
        printf("command -> ux_host_class_command_class = 0x%02x\r\n", command -> ux_host_class_command_class);
        printf("command -> ux_host_class_command_vid = 0x%02x\r\n", command -> ux_host_class_command_vid);
        if((command -> ux_host_class_command_usage == UX_HOST_CLASS_COMMAND_USAGE_PIDVID) &&
            ((command -> ux_host_class_command_class == 0x00)))
#endif
        {
