...
#define UX_DATA_MEMORY_BARRIER  __asm__ __volatile__("DMB");
...
CHAR                            _ux_version_id[] = 
                                    "Copyright (c) Microsoft Corporation. All rights reserved. * USBX Cortex-A7/GNU Version 6.1 *";
#else
