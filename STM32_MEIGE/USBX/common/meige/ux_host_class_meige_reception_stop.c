...
/*  FUNCTION                                               RELEASE        */ 
/*                                                                        */ 
/*    _ux_host_class_meige_reception_stop                  PORTABLE C      */ 
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
                                    ...
                                    UX_HOST_CLASS_MEIGE_RECEPTION *meige_reception)
{
    ...
    UX_TRACE_IN_LINE_INSERT(UX_TRACE_HOST_CLASS_MEIGE_RECEPTION_STOP, meige, 0, 0, 0, UX_TRACE_HOST_CLASS_EVENTS, 0, 0)
    ...
    if (meige_reception -> ux_host_class_meige_reception_state ==  UX_HOST_CLASS_MEIGE_RECEPTION_STATE_STOPPED)
        return(UX_SUCCESS);
